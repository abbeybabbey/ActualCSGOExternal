...
namespace signatures
{
	...
	constexpr ptrdiff_t dwClientState = 0x58BFDC;
	...
	constexpr ptrdiff_t dwEntityList = 0x4DD69DC;
	constexpr ptrdiff_t dwForceAttack = 0x3206E9C;
	constexpr ptrdiff_t dwForceAttack2 = 0x3206EA8;
	constexpr ptrdiff_t dwForceBackward = 0x3206EE4;
	constexpr ptrdiff_t dwForceForward = 0x3206ED8;
	constexpr ptrdiff_t dwForceJump = 0x5280924;
	constexpr ptrdiff_t dwForceLeft = 0x3206EF0;
	constexpr ptrdiff_t dwForceRight = 0x3206EFC;
	constexpr ptrdiff_t dwGameDir = 0x62A900;
	constexpr ptrdiff_t dwGameRulesProxy = 0x52F414C;
	constexpr ptrdiff_t dwGetAllClasses = 0xDE4CEC;
	constexpr ptrdiff_t dwGlobalVars = 0x58BCE0;
	constexpr ptrdiff_t dwGlowObjectManager = 0x531F608;
	constexpr ptrdiff_t dwInput = 0x5227FB0;
	constexpr ptrdiff_t dwInterfaceLinkList = 0x96B264;
	constexpr ptrdiff_t dwLocalPlayer = 0xDBA5BC;
	constexpr ptrdiff_t dwMouseEnable = 0xDC02C8;
	constexpr ptrdiff_t dwMouseEnablePtr = 0xDC0298;
	constexpr ptrdiff_t dwPlayerResource = 0x3205240;
	constexpr ptrdiff_t dwRadarBase = 0x520B754;
	constexpr ptrdiff_t dwSensitivity = 0xDC0164;
	constexpr ptrdiff_t dwSensitivityPtr = 0xDC0138;
	constexpr ptrdiff_t dwSetClanTag = 0x8A320;
	constexpr ptrdiff_t dwViewMatrix = 0x4DC82F4;
	constexpr ptrdiff_t dwWeaponTable = 0x5228A74;
	constexpr ptrdiff_t dwWeaponTableIndex = 0x326C;
	constexpr ptrdiff_t dwYawPtr = 0xDBFF28;
	constexpr ptrdiff_t dwZoomSensitivityRatioPtr = 0xDC6660;
	constexpr ptrdiff_t dwbSendPackets = 0xD81A2;
	constexpr ptrdiff_t dwppDirect3DDevice9 = 0xA5050;
	constexpr ptrdiff_t find_hud_element = 0x284155B0;
	constexpr ptrdiff_t force_update_spectator_glow = 0x3BCCEA;
	constexpr ptrdiff_t interface_engine_cvar = 0x3E9EC;
	constexpr ptrdiff_t is_c4_owner = 0x3C9D70;
	constexpr ptrdiff_t m_bDormant = 0xED;
	constexpr ptrdiff_t m_flSpawnTime = 0x103C0;
	constexpr ptrdiff_t m_pStudioHdr = 0x2950;
	constexpr ptrdiff_t m_pitchClassPtr = 0x520B9F0;
	constexpr ptrdiff_t m_yawClassPtr = 0xDBFF28;
	constexpr ptrdiff_t model_ambient_min = 0x58F054;
	constexpr ptrdiff_t set_abs_angles = 0x1E5990;
	constexpr ptrdiff_t set_abs_origin = 0x1E57D0;
} // namespace signatures
